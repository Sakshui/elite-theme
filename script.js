...
function renderSupportTickets(container) {
  ...
  ">
    ...
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:24px;">
      <div>
        <h2 style="margin:0 0 6px;font-size:20px;font-weight:700;font-family:var(--font-family);color:var(--heading-color);">
        <p style="margin:0;color:var(--card-heading-color);font-size:14px;font-family:var(--card-font-family);">
...
function statCard(label, value, color= "var(--card-text-color)") {
  return `
    <div style="
    ...
    ">
      <div style="font-size:28px;font-weight:700;color:${color};font-family:var(--secondaryFontFamily);">
        ${value}
      </div>
      <div style="font-size:14px;color: var(--card-label-color);margin-top:4px;font-family:var(--secondaryFontFamily);">
        ${label}
      </div>
    </div>
  `;
...
function ticketCard({ id, title, tag, desc, status, priority, meta, date, isUpdating }) {
  ...
  const style = tagStyles[tagKey] || { background: "#e5e7eb", color: "#374151" };
        ...
        <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
          <div>
            <div style="display:flex;align-items:center;gap:8px;margin-bottom:4px;">
              ...
              <div style="display:inline-flex;align-items:center;border-radius:999px;padding:2px 10px;font-size:12px;font-weight:600;background:${style.background};color:${style.color};">
                ${safeTag}
              </div>
            </div>
          ...
          <div style="display:flex;flex-direction:column;align-items:flex-end;gap:8px;margin-left:16px;">
            <div style="display:flex;align-items:center;gap:8px;">
              ...
              <div style="display:inline-flex;align-items:center;border-radius:999px;padding:2px 10px;font-size:12px;font-weight:600;background:${statusStyle.background};color:${statusStyle.color};">
                ${safeStatus}
              </div>
            </div>

            <div style="display:inline-flex;align-items:center;border-radius:999px;padding:2px 10px;font-size:12px;font-weight:600;${priorityStyles[priorityKey] || ""}">
              ${safePriority}
            </div>
          </div>
        </div>
